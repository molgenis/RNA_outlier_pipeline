...
#' Based on the optimized q-value from outrider_optim.R normalization is performed using the autoencoder.
#' P-values are calculated and the output is stored in the outrider.rds object.
